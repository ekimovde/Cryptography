...
import { Hill } from "components";

import { validate, hill } from "utils";
...
const HillBase = () => {
  ...
  const onSubmit = (event) => {
    ...
    if (type === "Зашифровать") {
      setText(hill.encoding(text, keyValue, lang));

      setType("Расшифровать");
    } else {
      setText(hill.decoding(text, keyValue, lang));
